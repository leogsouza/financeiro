...
class LancamentoController extends GxController 
{
	...
	public function actionView($id) 
    {
		$this->render('view', array(
			'model' => $this->loadModel($id, 'Lancamento'),
		));
	}
	...
	public function actionDelete($id) 
    {
        ...
        {
			$this->loadModel($id, 'Lancamento')->delete();
    ...
    {
		$dataProvider = new CActiveDataProvider('Lancamento');
	...
	public function actionAdmin() 
    {
		...
		if (isset($_GET['Lancamento']))
			$model->setAttributes($_GET['Lancamento']);
