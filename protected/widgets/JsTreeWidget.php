...
class JsTreeWidget extends CWidget
{
    ...
    private function register_Js_Css()
    {
        ...
        if($urlFormat == 'path') {
            $pathUrl = Yii::app()->urlManager->showScriptName ? '/index.php/' :'/';
        }
        else {
            $pathUrl = Yii::app()->urlManager->showScriptName ? '/index.php?r=':'?r=';
        }
...
EOD;
        ...
        Yii::app()->clientScript->registerCssFile($baseUrl . '/plugins/bootstrap/css/bootstrap.css');
