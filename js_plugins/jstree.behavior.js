    ...
    $("#" + JsTreeBehavior.container_ID)
        .jstree({
            ...
            "html_data":{
                "ajax":{
                    "type":"POST",
                    "url":Yii_js.baseUrl + JsTreeBehavior.pathUrl + JsTreeBehavior.controllerID + "/fetchTree",
                    "data":function (n) {
                        return {
            ...
            "contextmenu":{ 'items':{
                ...
                "update":{
                    ...
                    "action":function (obj) {
                        ...
                        $.ajax({
                            type:"POST",
                            url:Yii_js.baseUrl + JsTreeBehavior.pathUrl + JsTreeBehavior.controllerID + "/returnForm",
                            data:{
                                'update_id':id,
                                "YII_CSRF_TOKEN":Yii_js.csrf
                            },
                ...
                "properties":{
                    ...
                    "action":function (obj) {
                        ...
                        $.ajax({
                            type:"POST",
                            url:Yii_js.baseUrl + JsTreeBehavior.pathUrl + JsTreeBehavior.controllerID + "/returnView",
                            data:{
                                "id":id,
                                "YII_CSRF_TOKEN":Yii_js.csrf
                            },
        ...
        .bind("rename.jstree", function (e, data) {
            $.ajax({
                type:"POST",
                url:Yii_js.baseUrl + JsTreeBehavior.pathUrl + JsTreeBehavior.controllerID + "/rename",
                data:{
        ...
        .bind("remove.jstree", function (e, data) {
            $.ajax({
                type:"POST",
                url:Yii_js.baseUrl + JsTreeBehavior.pathUrl + JsTreeBehavior.controllerID + "/remove",
                data:{
                    "id":data.rslt.obj.attr("id").replace("node_", ""),
                    "YII_CSRF_TOKEN":Yii_js.csrf
                },
...
//                      console.log(replaced_node,'REPLACED NODE');
                ...
                $.ajax({
                    async:false,
                    type:'POST',
                    url:Yii_js.baseUrl + JsTreeBehavior.pathUrl + JsTreeBehavior.controllerID + "/moveCopy",
